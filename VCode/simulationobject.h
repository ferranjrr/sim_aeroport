...
class CSimulationObject{    
    public:
        ...
        virtual bool AcceptEntity(CEntity* entity, CSimulationObject* emissor) = 0;
        ...
        //virtual bool SendMeNow(CLeanSimulationObject* obj) = 0; En Monty en el document diu que hem d'afegir aquesta funció crec
    protected:
